  ...
  {    
    ...
    else if (choice == 6)
    {
      ...
      flag = false;
          ...
          puts("|1: go straight,|2: stay put, because why not|3: go left,|4: go back to the path you were in before, |5: go right,| 6: exit the game in case you are tired of this adventure| 7:  secret route");
          scanf("%d",&choice);
          switch(choice)
          {
          case 1:
          ...
          printf("while in the bushes you peek on the monster that you were afraid of and decided to write down what you saw in yourself notebook"); 
          while (getchar() != '\n');

          printf("the monster was a giant behemoth and when he walks almost knocking down mountains with just his stomps alone"); 
          while (getchar() != '\n');

          printf("the monster is also very vile as it sees a crocodile just walking in their little feet the monster runs at the crocodile and snaps it in two"); 
          while (getchar() != '\n');
          ...
          printf("after some time going forward and hiding from the nearby monsters  as well as from the local animals that have not yet noticed your presence"); 
          while (getchar() != '\n');
          ...
          printf("from there you meet up with a knight who just so happened to be traveling to the same swamp you were at"); 
          while (getchar() != '\n');

          printf("soon you went to the swamp with companion in tow");
          while (getchar() != '\n');

          printf("eventally you both went all the way to the end of the swamp and were able to reach the next city");
          ...
          printf("the knight says that they will flip a coin and if its heads he will continue the quest with you but if its tails he will give you a potion that will be useful in your journey to beating the game"); 
          while (getchar() != '\n');
          ...
          printf("you reached the error room, how did you reach it? nonetheless this is a celebrating"); 
	...
	switch(choose)
	{
		case 1:
		{
			...
			else if (liveOrDie == 2 && strength > 20)
			{
				...
				enterToContinue();
				puts("Pushing through the fire and the flames throughout the city, your tenacity surprises you, and you somehow reach safety.");
				alive = true;
				break;
			}
			else
